...
const Sidebar: React.FC<SidebarProps> = ({ sidebar, category, setCategory  }) => {
  return (
    <div className={`sidebar ${sidebar ? "" : "small-sidebar"}`}>
      ...
      <div className="subscribed-list">
        ...
        <div className="side-link">
          <img src={jack} alt="TheStraightPipes" /> <p>TheStraightPipes</p>
        </div>
        <div className="side-link">
          <img src={simon} alt="Mr. Beast" /> <p>Mr. Beast</p>
        </div>
        <div className="side-link">
          <img src={tom} alt="Minute Crafts" /> <p>Minute Crafts</p>
        </div>
        <div className="side-link">
          <img src={megan} alt="Ed Sheeran" /> <p>Ed Sheeran</p>
        </div>
        <div className="side-link">
          <img src={cameron} alt="Kai Cenat" /> <p>Kai Cenat</p>
        </div>
      </div>
    </div>
  );
